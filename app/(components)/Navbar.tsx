...
export default function Navbar() {
  return (
    <div id="navbar" className="md:h-[10%] bg-transparent text-white">
      <div className="min-w-96 max-w-screen-xl mx-auto h-full">
        <div className="px-6 md:px-8 py-4 md:py-6 flex items-center justify-between">
          {/* Links */}
          <div className="flex items-center space-x-4 md:space-x-10 lg:space-x-12">
            {/* ZEST */}
            <h2 className="text-2xl font-bold mr-2 md:mr-4">Zest</h2>
          ...
          {/* Sign In */}
          <Link
            className="min-w-24 md:min-w-32 h-7 md:h-10  bg-white rounded-full space-x-2 hover:bg-gray-300 text-black flex items-center justify-center transition-all duration-200"
